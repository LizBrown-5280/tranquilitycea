export const canastaTooltipContent = {
  ...
  canastaCountsExtras:
    'Count any extra 7s, 5s, and wilds to rack up additional points all contributing to your Big Count.',
  redThrees:
  ...
  remainingCount:
    'This can be used one of two ways: If you used the Fast Count, you can use the Remaining Count to track all the face values of the remaining Dirty Books, Wilds, and Burn Pile. Cards 3-7 are worth 5 points, cards 8-K are worth 10 points, and Aces and 2s are worth 20 points, and Jokers are worth 50 points. Alternatively, if you did not use the Fast Count, you can use the Remaining Count to track the total face value points of all cards in your hand at the end of the round (including Red 3s), which will be added to your Card Count.',
  negCount:
