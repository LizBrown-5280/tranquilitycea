...
<template>
  <section v-if="isShowing" class="session-modal-overlay" data-test="settings-panel">
    <div class="session-modal" role="dialog" aria-modal="true" aria-labelledby="settings-title">
      ...
      <div class="settings-field settings-field--version" data-test="settings-app-version">
